# Polar Bond Simulation (polar_bond)
...
This simulation illustrates the concept of a polar bond:

- Red dots represent electrons  
- Their movement demonstrates electron distribution in a polar covalent bond  
