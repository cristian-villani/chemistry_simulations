# Non polar Simulation (non_polar)
...
This project demonstrates the concept of non polar chemical bonds using
an interactive simulation.
The simulation shows a molecule containing two hydrogen atoms
and visualizes how electrons are more likely to be found in the middle of
the molecule.
It is intended as a didactical tool for chemistry students to intuitively understand electron distribution in molecules.
